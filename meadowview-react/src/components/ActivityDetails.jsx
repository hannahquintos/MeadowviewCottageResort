...
export default function SingleActivity() {
  ...
  const getSingleActivityRegistration = async (activityRegistrationId) => {
    const response = await fetch(`https://meadowview-cottage-resort-api.vercel.app/api/activityRegistrations/details/${activityRegistrationId}`);
  ...
  const deleteRegistration = async (activityRegistrationId) => {
    try {
      const res = await axios.get(`https://meadowview-cottage-resort-api.vercel.app/api/activityRegistrations/delete/${activityRegistrationId}`);
      handleClose();
