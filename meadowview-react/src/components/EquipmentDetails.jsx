...
export default function singleEquipment() {
  ...
  const getSingleEquipmentBooking = async (equipmentBookingId) => {
    const response = await fetch(`http://localhost:3000/api/equipmentBookings/details/${equipmentBookingId}`);
  ...
  useEffect(() => {
    ...
    const bookEquipment = async () => {
      try {
        ...
        const res = await axios.post("http://localhost:3000/api/equipmentBookings/create", formData);
    ...
    const deleteBooking = async (equipmentBookingId) => {
      ...
      try {
        const res = await axios.get(`http://localhost:3000/api/equipmentBookings/delete/${equipmentBookingId}`);
        handleClose();
